...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className='home__title'>Edin Mešanović
            <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
        ...
        <p className="home__description">Hello! I'm Edin, a passionate web developer with 2 years of experience in the industry.
        </p>
